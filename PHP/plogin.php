...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "SELECT * FROM clogin WHERE username='$username' AND password='$password'";
                    ...
                    <div class="col-md-6 col-lg-6 mx-auto">
                        <div class="login-wrap">
                            ...
                            <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                                <div class="log-form">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                <a class="forgot-link" href="pforgot-password.html">
                                                    Forgot password?
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <p class="no-acc">Don't have an account ? <a href="psignup.php">Register</a></p>
