    ...
    <div class="main-wrapper">
        ...
        <div class="breadcrumb-bar">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="breadcrumb-title mb-0">Bueaty Service Providers</h2>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="providerset-content">
                                <div class="providerset-price">
                                    <div class="providerset-name">
                                        <h4><a href="provider-details.html">Anamika</a><i class="fa fa-check-circle"
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="providerset">
                            ...
                            <div class="providerset-content">
                                <div class="providerset-price">
                                    <div class="providerset-name">
                                        <h4><a href="provider-details.html">deepak</a><i class="fa fa-check-circle"
                                                aria-hidden="true"></i></h4>
                                        <span>Beautician</span>
                                    </div>
                                    <div class="providerset-prices">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="providerset">
                            ...
                            <div class="providerset-content">
                                <div class="providerset-price">
                                    <div class="providerset-name">
                                        <h4><a href="provider-details.html">Kashish</a><i class="fa fa-check-circle"
                                                aria-hidden="true"></i></h4>
                                        <span>Beautician</span>
                                    </div>
                                    <div class="providerset-prices">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="providerset">
                            ...
                            <div class="providerset-content">
                                <div class="providerset-price">
                                    <div class="providerset-name">
                                        <h4><a href="provider-details.html">Neha</a><i class="fa fa-check-circle"
                                                aria-hidden="true"></i></h4>
                                        <span>Beautician</span>
                                    </div>
                                    <div class="providerset-prices">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="providerset">
                            ...
                            <div class="providerset-content">
                                <div class="providerset-price">
                                    <div class="providerset-name">
                                        <h4><a href="provider-details.html">Ravi</a><i class="fa fa-check-circle"
                                                aria-hidden="true"></i></h4>
                                        <span>Beautician</span>
                                    </div>
                                    <div class="providerset-prices">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="providerset">
                            ...
                            <div class="providerset-content">
                                <div class="providerset-price">
                                    <div class="providerset-name">
                                        <h4><a href="provider-details.html">Suhani</a><i class="fa fa-check-circle"
                                                aria-hidden="true"></i></h4>
                                        <span>Beautician</span>
                                    </div>
                                    <div class="providerset-prices">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="providerset">
                            ...
                            <div class="providerset-content">
                                <div class="providerset-price">
                                    <div class="providerset-name">
                                        <h4><a href="provider-details.html">Shubhangi</a><i class="fa fa-check-circle"
                                                aria-hidden="true"></i></h4>
                                        <span>Beautician</span>
                                    </div>
                                    <div class="providerset-prices">
