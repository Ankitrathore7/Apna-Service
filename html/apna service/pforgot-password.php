...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "SELECT * FROM plogin WHERE email = '$email'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($result) {
            $sql = "UPDATE plogin SET password = '$password' WHERE email = '$email'";
       ...
       ?>
        ...
        echo "<script>alert('Please check your mail does not exist!');</script>";
    }
}
ob_end_flush();
?>
