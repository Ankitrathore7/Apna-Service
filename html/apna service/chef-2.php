    ...
    <div class="main-wrapper">
        ...
        <div class="breadcrumb-bar">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="breadcrumb-title mb-0"> Cooking Service Providers</h2>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="providerset-content">
                                <div class="providerset-price">
                                    <div class="providerset-name">
                                        <h4><a href="provider-details.html">Krish</a><i class="fa fa-check-circle"
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="providerset">
                            ...
                            <div class="providerset-content">
                                <div class="providerset-price">
                                    <div class="providerset-name">
                                        <h4><a href="provider-details.html">Ajay</a><i class="fa fa-check-circle"
                                                aria-hidden="true"></i></h4>
                                        <span>Chef</span>
                                    </div>
                                    <div class="providerset-prices">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="providerset">
                            ...
                            <div class="providerset-content">
                                <div class="providerset-price">
                                    <div class="providerset-name">
                                        <h4><a href="provider-details.html">chaitanya</a><i class="fa fa-check-circle"
                                                aria-hidden="true"></i></h4>
                                        <span>Chef</span>
                                    </div>
                                    <div class="providerset-prices">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="providerset">
                            ...
                            <div class="providerset-content">
                                <div class="providerset-price">
                                    <div class="providerset-name">
                                        <h4><a href="provider-details.html">Jatin</a><i class="fa fa-check-circle"
                                                aria-hidden="true"></i></h4>
                                        <span>Chef</span>
                                    </div>
                                    <div class="providerset-prices">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="providerset">
                            ...
                            <div class="providerset-content">
                                <div class="providerset-price">
                                    <div class="providerset-name">
                                        <h4><a href="provider-details.html">Ramniwas</a><i class="fa fa-check-circle"
                                                aria-hidden="true"></i></h4>
                                        <span>Chef</span>
                                    </div>
                                    <div class="providerset-prices">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="providerset">
                            ...
                            <div class="providerset-content">
                                <div class="providerset-price">
                                    <div class="providerset-name">
                                        <h4><a href="provider-details.html">Sandeep</a><i class="fa fa-check-circle"
                                                aria-hidden="true"></i></h4>
                                        <span>Chef</span>
                                    </div>
                                    <div class="providerset-prices">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="providerset">
                            ...
                            <div class="providerset-content">
                                <div class="providerset-price">
                                    <div class="providerset-name">
                                        <h4><a href="provider-details.html">shobhit</a><i class="fa fa-check-circle"
                                                aria-hidden="true"></i></h4>
                                        <span>Chef</span>
                                    </div>
                                    <div class="providerset-prices">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="providerset">
                            ...
                            <div class="providerset-content">
                                <div class="providerset-price">
                                    <div class="providerset-name">
                                        <h4><a href="provider-details.html">Satya</a><i class="fa fa-check-circle"
                                                aria-hidden="true"></i></h4>
                                        <span>Chef</span>
                                    </div>
                                    <div class="providerset-prices">
