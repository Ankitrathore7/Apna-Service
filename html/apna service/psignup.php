    ...
    if (isset($_FILES["profile_pic"])) {
        ...
        if (!is_dir($target_dir) || !is_writable($target_dir)) {
            ...
            if (move_uploaded_file($file_tmp, $target_file)) {
                ...
                $insert_query = "INSERT INTO plogin (username, password, email, mobile, service, profile_pic,city) VALUES ('$username','$password', '$email', '$mobile', '$service', '$target_file','$city')";
                        ...
                        <div class="login-wrap">
                            ...
                            <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="city" id="city" class="form-control form-control-lg group_formcontrol" required>
                                ...
                                <p class="no-acc">Already have an account ? <a href="plogin.php"> Sign In</a></p>
                            </form>
